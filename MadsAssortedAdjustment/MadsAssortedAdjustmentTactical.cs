...
namespace MadsAssortedAdjustment
{
	...
	public class MadsAssortedAdjustmentTacInstanceData
	{
	...
	/// </summary>
	public class MadsAssortedAdjustmentTactical : ModTactical
	{
		/// <summary>
		...
		public override void OnTacticalStart() {
			...
			MadsAssortedAdjustmentMain main = (MadsAssortedAdjustmentMain)Main;
		}
		/// <summary>
		...
		public override void ProcessTacticalInstanceData(object instanceData) {
			MadsAssortedAdjustmentTacInstanceData data = (MadsAssortedAdjustmentTacInstanceData)instanceData;
		}
		/// <summary>
		...
		public override object RecordTacticalInstanceData() {
			 return new MadsAssortedAdjustmentTacInstanceData() { ExampleData = 5 };
		}
		/// <summary>
