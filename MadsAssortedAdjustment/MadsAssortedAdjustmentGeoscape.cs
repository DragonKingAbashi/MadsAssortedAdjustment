...
namespace MadsAssortedAdjustment
{
	...
	public class MadsAssortedAdjustmentGSInstanceData
	{
	...
	/// </summary>
	public class MadsAssortedAdjustmentGeoscape : ModGeoscape
	{
		/// <summary>
		...
		public override object RecordGeoscapeInstanceData() {
			return new MadsAssortedAdjustmentGSInstanceData() { ExampleData = 5 };
		}
		/// <summary>
		...
		public override void ProcessGeoscapeInstanceData(object instanceData) {
			MadsAssortedAdjustmentGSInstanceData data = (MadsAssortedAdjustmentGSInstanceData)instanceData;
		}
