...
- MadsAssortedAdjustmentConfig.cs: Example of ModConfig for custom mod settings;
- MadsAssortedAdjustmentGeoscape.cs: Example of ModGeoscape for modifying geoscape level;
- MadsAssortedAdjustmentMain.cs: Main mod class, recieves mod management and general events;
- MadsAssortedAdjustmentTactical.cs: Example of ModTactical for modifying tactical level;
